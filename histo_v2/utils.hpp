...
#ifndef HISTO_V2_UTILS_HPP
#define HISTO_V2_UTILS_HPP

#endif //HISTO_V2_UTILS_HPP
...
Mat query_img()
{
    do {
        ...
        String  fname = format("/home/iotuser/다운로드/DB/img_%02d.jpg", q_no);
...
void select_view(double sinc, Mat DB_similaritys)
{
    ...
    for (int i = 0; i < (int)sorted_sim.total(); i++)
    {
        ...
        if (sim > sinc)
        {
            ...
            String  fname = format("/home/iotuser/다운로드/DB/img_%02d.jpg", idx);
