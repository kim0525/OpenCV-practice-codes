...
#ifndef PAINTBRUSH_V1_DRAW_HPP
#define PAINTBRUSH_V1_DRAW_HPP

#endif //PAINTBRUSH_V1_DRAW_HPP
...
void  draw(Mat  image, Scalar color = Scalar(200, 200, 200))
{
    ...
    else if (draw_mode == DRAW_ECLIPSE)
    {
        ...
        Size2d size = ((Point2d)pt1 - (Point2d)pt2) / 2.0;
...
void  command(int mode)				// 일반 명령 수행
{
    ...
    {
        Mat tmp = imread("./image/icon/my_picture.jpg", 1);
        CV_Assert(tmp.data);
